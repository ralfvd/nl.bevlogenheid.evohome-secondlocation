...
reset_temperature
 ...
 if ( !evohomeUser || !evohomePassword ) {
   new Homey.Notification({excerpt:'Evohome 2nd location: missing username or password; enter your Honeywell credentials in app settings'}) // username + password set?
       .register();
